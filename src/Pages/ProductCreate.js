...
const ProductCreate = () => {
    ...
    return (
        <>
            {toastSuccess && <ToastComponent text={'Added Successfully'} type={'success'} position={'top-end'} />}
            {toastError && <ToastComponent text={'Create : Error'} type={'error'} position={'top-end'} />}
            <div
                style={{
                    display: 'flex',
                    alignItems: 'center',
